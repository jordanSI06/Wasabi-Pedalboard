(function () {
  ...
  customElements.define('wc-multitrack', class extends HTMLElement {
    ...
    getElement(){
      ...
      .then(function (stream) {
        ...
        this.recordButton.addEventListener('click', startRecording);
        this.stopButton.addEventListener('click', stopRecording);
        this.recorder = new MediaRecorder(stream);
        this.recorder.addEventListener('dataavailable', onRecordingReady);
        this.recorder.addEventListener('start', onRecordingStarted);
  ...
  RenderWave(canvas, data){
    ...
    let canvasHeigth = this.canvas.width;
    ...
    let sliceWidth = vanvasWidth * 1.0 / this.bufferLength;
    let x = 0 - sliceWidth;
