const _currentDocPedalOut = document.currentScript.ownerDocument;
console.log("PEDAL OUT");

class PedalOut extends PBPlugin(HTMLElement) {
  // ----- METHODS: DEFAULT -----
  // is called when an instance of the element is created
  constructor() {
    // Toujours appeler "super" d'abord dans le constructeur
    super();
    console.log("PEDAL OUT CONSTRUCTOR");
  ...
  connectedCallback() {
    ...
    const template = _currentDocPedalOut.querySelector(`#pedaloutTemplate`);
    const instance = template.content.cloneNode(true);
    shadowRoot.appendChild(instance);

    this.runBehaviorMethods();

    console.log("PEDAL OUT CONNECTED VALLBACK");
  }

  // ----- METHODS: CUSTOM -----
}

customElements.define(`pedal-out`, PedalOut);
/*
(function() {
